...
- {future} not queued and blocks if tasks > workers
...
- Reduces task resolution time from milliseconds to microseconds
...
- `mirai()` event-driven promises
- Efficient and zero-latency
- Launch one million promises simultaneously
