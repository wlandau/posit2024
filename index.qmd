...
* Machine learning, Bayesian data analysis, genomics, and simulation are demanding.
* Parallel/async computing is essential.
* `crew` and `mirai` are next-gen parallel/async for R.
...
* Offers plugins for clusters and cloud services.
* Supports users to write custom plugins.
