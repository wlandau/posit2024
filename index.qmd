...
* Machine learning, Bayesian data analysis, genomics, simulation, etc. need parallel/async computing.
* `crew` and `mirai`: next-gen parallel/async packages for R.
    1. Fast: high throughput, low overhead
    1. Adaptable: SLURM, AWS Batch, user-defined plugins, etc. 
    1. Friendly: compatible with Shiny, `promises`, and `targets`.
