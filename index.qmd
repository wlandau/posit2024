...
<center>
<img src="./images/mirai-crew.png" width=575>
</center>

* Modern: next-gen parallel computing for R.
* Fast: high throughput and low overhead.
* Adaptable: SLURM, AWS Batch, user-defined plugins, etc. 
* Friendly: seamless with Shiny, `promises`, and `targets`.
