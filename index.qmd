...
<span style="color:darkgreen">Parallelism is the ability to do multiple things at once</span>

. . .

<span style="color:darkgreen">Async is not waiting while this happens</span>
...
This app simulates thousands of coin flips to determine if a coin is fair. Each coin flip is a task, and these are run in parallel.
