...
<span style="color:darkorange">Async is the ability to do multiple things at once.</span>

. . .

<span style="color:darkorange">And keep doing more of those things.</span>
...
<span style="color:brown">Hardly a 'first-class' experience</span>
...
- {mirai} uses {nanonext} to deliver async
- Enables thousands of parallel processes
- Launch millions of tasks all at once
- Response time from milliseconds to microseconds

## The current generation of promises

Shiny ExtendedTask takes a 'promising' object:
...
- `mirai()` can be used wherever a 'promise' is accepted
- Native support for Shiny ExtendedTask
- Event-driven: efficient and zero-latency
- Allows launching one million promises simultaneously
