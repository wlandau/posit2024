...
```r
extended <- ExtendedTask$new(func = identity)

observeEvent(input$button, {
  extended$invoke(controller$push(run_task(), ...))
})
```
...
* `mirai` + `promises` integration and Shiny extended tasks.

::::

## Tasks to not block the app.
